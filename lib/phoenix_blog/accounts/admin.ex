defmodule PhoenixBlog.Accounts.Admin do
  use Ecto.Schema
  ...
  defp validate_email(changeset) do
    ...
    |> unsafe_validate_unique(:email, PhoenixBlog.Repo)
  ...
  @doc """
  A admin changeset for changing the e-mail.
  ...
  """
  def valid_password?(%PhoenixBlog.Accounts.Admin{hashed_password: hashed_password}, password)
