defmodule PhoenixBlog.Accounts do
  ...
  alias PhoenixBlog.Accounts.{Admin, AdminToken, AdminNotifier}
  ...
  @doc """
  Returns an `%Ecto.Changeset{}` for changing the admin e-mail.
  ...
  @doc """
  Updates the admin e-mail in token.
  ...
  @doc """
  Delivers the update e-mail instructions to the given admin.
  ...
  @doc """
  Delivers the confirmation e-mail instructions to the given admin.
  ...
  @doc """
  Delivers the reset password e-mail to the given admin.
