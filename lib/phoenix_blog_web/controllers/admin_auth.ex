defmodule PhoenixBlogWeb.AdminAuth do
  import Plug.Conn
  ...
  def log_out_admin(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      PhoenixBlogWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  If you want to enforce the admin e-mail is confirmed before
  ...
  defp maybe_store_return_to(%{method: "GET", request_path: request_path} = conn) do
    put_session(conn, :admin_return_to, request_path)
  end
