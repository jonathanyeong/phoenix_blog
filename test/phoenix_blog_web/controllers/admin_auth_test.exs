defmodule PhoenixBlogWeb.AdminAuthTest do
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, PhoenixBlogWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_admin/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      PhoenixBlogWeb.Endpoint.subscribe(live_socket_id)
  ...
  describe "require_authenticated_admin/2" do
    ...
    test "stores the path to redirect to on GET", %{conn: conn} do
      ...
      assert get_session(halted_conn, :admin_return_to) == "/foo?bar"
